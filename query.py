...
def generate_queries():
    ...
    queries = {
        ...
        'psp_query': f"""select * from gna_database.psp_report_all_india where date = '{previousDate_str}' and regions='TOTAL' allow filtering""",
        ...
        'frequency_query': f"""select * from gna_database.frequency_psp where id = '{previousDate_str}' allow filtering""",
